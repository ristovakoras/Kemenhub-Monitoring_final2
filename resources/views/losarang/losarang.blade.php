                ...
                <table class="table align-middle gs-0 gy-4" style="color: white;">
                    ...
                    <thead>
                        <tr class="fw-bolder text-muted text-center" style="vertical-align: middle; background-color: #302e74;">
                            ...
                            <th colspan="5" class="min-w-90px">Lidar</th>
                            <th colspan="3" class="min-w-90px">WIM</th>
                        ...
                        <tr class="fw-bolder text-muted text-center" style="vertical-align: middle; background-color: #302e74;">
                            ...
                            <th class="min-w-90px">Standar</th>
                            <th class="min-w-90px">Pengukuran</th>
                            <th class="min-w-90px">Deviasi</th>
                            <th class="min-w-90px">Presentase</th>
                            <th class="min-w-100px">Berat</th>
                            <th class="min-w-100px">JBI</th>
                    ...
                    <tbody class="">
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    <p>{{ $wim->LidarLimitLength }}</p>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex justify-content-center">
                                    <p>{{ $wim->LidarReadingLength }}</p>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex justify-content-center">
                                    <p>{{ $wim->LidarOverLength }}</p>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex justify-content-center">
                                    <p>{{ $wim->LidarPercentageLength }}</p>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex justify-content-center">
                        ...
                        <tr>
                            ...
                            <th>
                                <div class="d-flex justify-content-center">
                                    <p>{{ $wim->LidarLimitWidth }}</p>
                                </div>
                            </th>
                            <th>
                                <div class="d-flex justify-content-center">
                                    <p>{{ $wim->LidarReadingWidth }}</p>
                                </div>
                            </th>
                            <th>
                                <div class="d-flex justify-content-center">
                                    <p>{{ $wim->LidarOverWidth }}</p>
                                </div>
                            </th>
                            <th>
                                <div class="d-flex justify-content-center">
                                    <p>{{ $wim->LidarPercentageWidth }}</p>
                                </div>
                            </th>
                            <th class="fw-bolder text-muted text-center min-w-100px" style="vertical-align: middle; background-color: #302e74;">
                                <div class="d-flex justify-content-center">
                                    <p>Berat Berlebih</p>
                                </div>
                            </th>
                        ...
                        <tr>
                            ...
                            <th>
                                <div class="d-flex justify-content-center">
                                    <p>{{ $wim->LidarLimitHeight }}</p>
                                </div>
                            </th>
                            <th>
                                <div class="d-flex justify-content-center">
                                    <p>{{ $wim->LidarReadingHeight }}</p>
                                </div>
                            </th>
                            <th>
                                <div class="d-flex justify-content-center">
                                    <p>{{ $wim->LidarOverHeight }}</p>
                                </div>
                            </th>
                            <th>
                                <div class="d-flex justify-content-center">
                                    <p>{{ $wim->LidarPercentageHeight }}</p>
                                </div>
                            </th>
                            <td>
                                <div class="d-flex justify-content-center">

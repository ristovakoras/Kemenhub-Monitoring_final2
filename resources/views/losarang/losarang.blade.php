                ...
                <table class="table align-middle gs-0 gy-4" style="color: white;">
                    ...
                    <tbody class="">
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    <p>{{ $wim->LidarReadingLength }} M</p>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex justify-content-center">
                                    <p>{{ $wim->LidarOverLength }} M</p>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex justify-content-center">
                        ...
                        <tr>
                            ...
                            <th>
                                <div class="d-flex justify-content-center">
                                    <p>{{ $wim->LidarReadingWidth }} M</p>
                                </div>
                            </th>
                            <th>
                                <div class="d-flex justify-content-center">
                                    <p>{{ $wim->LidarOverWidth }} M</p>
                                </div>
                            </th>
                            <th>
                                <div class="d-flex justify-content-center">
                        ...
                        <tr>
                            ...
                            <th>
                                <div class="d-flex justify-content-center">
                                    <p>{{ $wim->LidarReadingHeight }} M</p>
                                </div>
                            </th>
                            <th>
                                <div class="d-flex justify-content-center">
                                    <p>{{ $wim->LidarOverHeight }} M</p>
                                </div>
                            </th>
                            <th>
                                <div class="d-flex justify-content-center">
                                    <p>{{ $wim->LidarPercentageHeight }} M</p>
                                </div>
                            </th>
                            <td>
                                <div class="d-flex justify-content-center">
